...
2. **裁切是唯一能买到细节的手段**——有效细节密度约 **2.7 倍**，而成本几乎不变
...
这条后来在**源码里得到了解释**：provider 把每张请求图重排到 14px patch 网格、每轴 3:1 下采样、**单图上限 384 token**——1942×1030 与 1295×687 因此落到**同一个 ≈950×504 的网格**上。同一个机制也解释了为什么**裁切有效**：675×387 的裁切会被放大到 ≈879×504，有效细节密度约 **2.7 倍**。
